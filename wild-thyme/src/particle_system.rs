...
pub fn cull_dead_particles(ecs: &mut World, ctx: &Rltk) {
    ...
    for dead in dead_particles.iter() {
        ecs.delete_entity(*dead)
            .expect("should be able to delete dead particles");
    }
}
    ...
    fn run(&mut self, data: Self::SystemData) {
        ...
        for new_particle in particle_builder.requests.iter() {
            ...
            positions
                ...
                .expect("should be able to insert a position for new particle");
            renderables
                .insert(
                    p,
                    Renderable {
            ...
            particles
                ...
                .expect("should be able to insert a particle's lifetime");
        }
